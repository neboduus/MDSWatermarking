...
attack_config.lazy = true; %If true then stop attacking a soon as a succesful attack is delivered
...
FilterConfiguration().setFilter(FilterEnum.BLURRING).setNoisepower(4)
];
